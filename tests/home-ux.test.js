...
describe('Home UX information architecture', () => {
  ...
  it('groups Home information into progress, race readiness, and secondary cards', () => {
    const html = readIndexHtml();
    ...
    expect(html).toContain('class="home-secondary-grid"');
    expect(html).toContain('Open Garage');
